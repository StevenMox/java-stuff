...
public class Date {
	...
	public int lilian() {
		...
		//
		// Computes the number of days between 1/1/0 and this date as if no
		// calendar
		// reforms took place, then subtracts 578,100 so that October 15, 1582
		// is day 1.

		final int subDays = 578100; // number of calculated days from 1/1/0 to
									// 10/14/1582
